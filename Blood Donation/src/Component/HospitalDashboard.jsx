  ...
  const handleEditToggle = () => {
    if (editMode) {
      ...
      setProfileEdits({
        ...
        services: (profile.services && profile.services.join(', ')) || ''
      });
    }
  ...
  return (
    <div className="hospital-dashboard">
      <div className="dashboard-header">
        ...
        <div className="hospital-name">{profile.name || 'Hospital'}</div>
            ...
            {editMode ? (
              ...
              <div className="profile-info">
                ...
                <div className="info-item">
                  ...
                  <span className="info-value">{profile.district || 'N/A'}</span>
                </div>
                <div className="info-item">
                  <span className="info-label">State:</span>
                  <span className="info-value">{profile.state || 'N/A'}</span>
                </div>
                {profile.description && (
                  <div className="info-item">
                ...
                <div className="info-item">
                  ...
                  <span className={`info-value status-badge ${profile.approvalStatus || 'pending'}`}>
                ...
                {bloodRequests.map(request => (
                  <div key={request._id || request.id} className="request-card">
                    <div className="request-header">
                      <div className="request-blood-type">{request.bloodType || 'N/A'}</div>
                      <div className={`request-status ${getStatusBadgeClass(request.status || 'pending')}`}>
                    ...
                    <div className="request-details">
                      ...
                      <div className="request-info">
                        ...
                        <span>{request.contactPerson || 'N/A'}, {request.contactPhone || 'N/A'}</span>
                      </div>
                      {request.notes && (
                        <div className="request-info">
